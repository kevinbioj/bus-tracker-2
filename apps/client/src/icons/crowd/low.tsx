...
type LowCrowdIconProps = Omit<ComponentPropsWithoutRef<"svg">, "xmlns" | "viewBox">;

export function LowCrowdIcon(props: Readonly<LowCrowdIconProps>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" {...props}>
			<title>Faible affluence</title>
