...
type MediumCrowdIconProps = Omit<ComponentPropsWithoutRef<"svg">, "xmlns" | "viewBox">;

export function MediumCrowdIcon(props: Readonly<MediumCrowdIconProps>) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" {...props}>
			<title>Affluence moyenne</title>
