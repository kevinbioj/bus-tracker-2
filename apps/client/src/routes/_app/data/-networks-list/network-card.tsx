...
export function NetworksListCard({ network }: Readonly<NetworksListCardProps>) {
	return (
		<div className="h-16 relative w-full" key={network.id}>
			...
			<Button
				className="border drop-shadow-md flex justify-between items-center h-16 px-2 py-2 rounded-lg shadow-md transition-colors relative overflow-hidden bg-primary/25 text-neutral-800 dark:text-neutral-200 card-network-background"
				style={{
