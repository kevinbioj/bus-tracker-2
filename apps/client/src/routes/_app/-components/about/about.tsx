		...
		<Dialog>
			...
			<DialogContent aria-describedby={undefined} className="max-h-[95dvh] overflow-y-auto">
				...
				<div className="space-y-4 text-center sm:text-left">
					<p>{m.about_build({ buildHash, builtAt: builtAt.format("LLLL") })}</p>
					<p>
						{m.about_contact()}
						<br />
					...
					<div className="space-y-2">
						...
						<p className="text-center">
							<Link external href="https://kevinbioj.fr" target="_blank">
								kevinbioj.fr
							</Link>{" "}
							•{" "}
							<Link external href="https://github.com/kevinbioj/bus-tracker-2" target="_blank">
								GitHub
							</Link>{" "}
							•{" "}
							<Link external href="https://discord.gg/DpwtEU4qBg" target="_blank">
								Discord
							</Link>
						</p>
					</div>
