...
const sources = [
  {
    id: "amiens",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/5bc8b7dc-0d4e-48e7-b2ec-eccfe3702c19",
  ...
  },
  {
    id: "arras",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/e3ff01b4-bac9-40b6-83a3-4b91ce0045b5",
    realtimeResourceHrefs: [],
    getNetworkRef: () => "ARTIS",
  },
  {
  ...
  },
  {
    id: "calais",
    staticResourceHref:
      "https://zenbus.net/gtfs/static/download.zip?dataset=sitac-calais-rt",
    realtimeResourceHrefs: [
      "https://zenbus.net/gtfs/rt/poll.proto?dataset=sitac-calais-rt",
    ],
  ...
  },
  {
    id: "lens-bethune",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/d4efef07-b80d-4922-af53-1599f5b5628a",
    realtimeResourceHrefs: [],
    getNetworkRef: () => "TADAO",
  },
];
