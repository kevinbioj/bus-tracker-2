...
const sources = [
  ...
  },
  {
    id: "angers",
    staticResourceHref:
      "https://chouette.enroute.mobi/api/v1/datas/Irigo/gtfs.zip",
    realtimeResourceHrefs: [
  ...
  },
  {
    id: "lemans",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/5339d96c-6d20-4a01-939a-40f7b56d6cc1",
    realtimeResourceHrefs: [
  ...
  },
  {
    id: "remi-28",
    staticResourceHref:
      "https://www.transdev-centrevaldeloire.com/cvl/open-data/remi-28/gtfs",
    realtimeResourceHrefs: [
      "https://pysae.com/api/v2/groups/eure-et-loir-mobilite/gtfs-rt",
    ],
    mode: "NO-TU",
    getNetworkRef: () => "REMI",
  ...
  },
  {
    id: "remi-37",
    staticResourceHref:
      "https://www.transdev-centrevaldeloire.com/cvl/open-data/remi-37/gtfs",
  ...
  },
  {
    id: "remi-41",
    staticResourceHref:
      "https://www.transdev-centrevaldeloire.com/cvl/open-data/remi-41/gtfs",
  ...
  },
  {
    id: "remi-45",
    staticResourceHref:
      "https://www.transdev-centrevaldeloire.com/cvl/open-data/remi-45/gtfs",
