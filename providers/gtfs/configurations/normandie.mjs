...
const sources = [
  //- NOMAD
  {
    ...
    excludeScheduled: (trip) =>
      ["216", "228", "423", "424", "527", "530"].includes(trip.route.name),
    ...
    mapTripRef: (tripRef) =>
      tripRef.slice(
        nthIndexOf(tripRef, ":", 2) + 1,
        nthIndexOf(tripRef, ":", 3)
      ),
  },
  {
    id: "nomad-car-geo3d",
  ...
  //- Cap Cotentin
  {
    id: "cap-cotentin",
    staticResourceHref:
      "https://pysae.com/api/v2/groups/transdev-cotentin/gtfs/pub",
    realtimeResourceHrefs: [
  ...
  //- SEMO
  {
    id: "semo",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/98bbbf7c-10ff-48a0-afc2-c5f7b3dda5af",
    getNetworkRef: () => "SEMO",
    mapLineRef: (lineRef) =>
      lineRef.slice(
        nthIndexOf(lineRef, ":", 2) + 1,
  ...
  //- Transurbain
  {
    id: "transurbain",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/ec78df83-2e60-4284-acc3-86a0baa76bf0",
    realtimeResourceHrefs: [
    ...
    getVehicleRef: (vehicleDescriptor) =>
      vehicleDescriptor?.id.padStart(2, "0"),
    mapLineRef: (lineRef) =>
      lineRef.slice(
        nthIndexOf(lineRef, ":", 2) + 1,
        nthIndexOf(lineRef, ":", 3)
  ...
  //- SNgo!
  {
    id: "sngo",
    staticResourceHref:
      "https://pysae.com/api/v2/groups/transdev-normandie-interurbain/gtfs/67a5e4bbde9c67ea268cfa64",
  ...
  //- Astrobus
  {
    id: "astrobus",
    staticResourceHref:
      "https://zenbus.net/gtfs/static/download.zip?dataset=astrobus",
    realtimeResourceHrefs: [
      "https://zenbus.net/gtfs/rt/poll.proto?dataset=astrobus",
    ],
    gtfsOptions: { shapesStrategy: "IGNORE" },
    mode: "VP-ONLY",
    excludeScheduled: true,
  ...
  //- RezoBus
  {
    id: "rezobus",
    staticResourceHref:
      "https://pysae.com/api/v2/groups/caux-seine-agglo/gtfs/pub",
    realtimeResourceHrefs: [
      "https://pysae.com/api/v2/groups/caux-seine-agglo/gtfs-rt",
    ],
    gtfsOptions: { shapesStrategy: "IGNORE" },
    mode: "NO-TU",
  ...
  //- Neva
  {
    id: "neva",
    staticResourceHref:
      "https://zenbus.net/gtfs/static/download.zip?dataset=granville",
    realtimeResourceHrefs: [
      "https://zenbus.net/gtfs/rt/poll.proto?dataset=granville",
    ],
    gtfsOptions: { shapesStrategy: "IGNORE" },
    mode: "NO-TU",
    excludeScheduled: true,
  ...
  //- Ficibus
  {
    id: "ficibus",
    staticResourceHref:
      "https://exs.atm.cityway.fr/gtfs.aspx?key=OPENDATA&operatorCode=FICIBUS",
    realtimeResourceHrefs: [
  ...
  //- Némus
  {
    id: "flers",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/388da89c-d15b-4496-810a-be250be9a26a",
    realtimeResourceHrefs: [
  ...
  //- Bybus
  {
    id: "bybus",
    staticResourceHref:
      "https://pysae.com/api/v2/groups/keolis-bayeux/gtfs/pub",
    realtimeResourceHrefs: [
      "https://pysae.com/api/v2/groups/keolis-bayeux/gtfs-rt",
    ],
    gtfsOptions: { shapesStrategy: "IGNORE" },
    mode: "NO-TU",
    excludeScheduled: true,
  ...
  //- i'Bus
  {
    id: "ibus",
    staticResourceHref:
      "https://zenbus.net/gtfs/static/download.zip?dataset=bernay",
    realtimeResourceHrefs: [
      "https://zenbus.net/gtfs/rt/poll.proto?dataset=bernay",
    ],
    gtfsOptions: { shapesStrategy: "IGNORE" },
    mode: "NO-TU",
    excludeScheduled: true,
  ...
  //- Slambus
  {
    id: "slambus",
    staticResourceHref:
      "https://exs.atm.cityway.fr/gtfs.aspx?key=OPENDATA&operatorCode=SLAM",
  ...
  //- Vikibus
  {
    id: "vikibus",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/b3e50a9c-bdca-42c5-b04b-aeba964b0df8",
  ...
  //- Argentan Bus
  {
    id: "argentan-bus",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/bccfa3f2-ef45-4b9e-9586-7e117286bc60",
    realtimeResourceHrefs: [],
  ...
  //- Cosibus
  {
    id: "cosibus",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/ff3d0940-f19a-4981-b4b1-6ddbc9c6018f",
    realtimeResourceHrefs: [],
  ...
  //- Amibus
  {
    id: "amibus",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/cdd4681c-dfcb-46c1-8802-2aae4f296618",
    realtimeResourceHrefs: [],
  ...
  //- LeBus (Pont-Audemer)
  {
    id: "lebus",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/e8fe8980-c502-466c-9054-ddb28d367e4f",
    getNetworkRef: () => "LEBUS",
    mapLineRef: (lineRef) =>
      lineRef.slice(
        nthIndexOf(lineRef, ":", 2) + 1,
