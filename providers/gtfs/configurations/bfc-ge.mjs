...
const sources = [
  {
    id: "dijon",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/e0dbd217-15cd-4e28-9459-211a27511a34",
  ...
  },
  {
    id: "montbeliard",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/b45aa8d8-4bd4-4528-99c7-acfc980fdb09",
    realtimeResourceHrefs: [],
    gtfsOptions: { shapesStrategy: "IGNORE" },
  ...
  },
  {
    ...
    realtimeResourceHrefs: [
      "https://proxy.transport.data.gouv.fr/resource/fluo-citura-reims-gtfs-rt",
    ],
    excludeScheduled: true,
    mode: "NO-TU",
    getNetworkRef: () => "GRM",
  },
  {
    ...
    realtimeResourceHrefs: [
      "https://gtfs.bus-tracker.fr/gtfs-rt/cts/trip-updates",
    ],
    excludeScheduled: true,
    getNetworkRef: () => "CTS",
  },
  {
    id: "troyes",
    staticResourceHref:
      "https://www.data.gouv.fr/fr/datasets/r/764e07f3-4297-44ac-810e-f3db295dbef6",
    realtimeResourceHrefs: [
